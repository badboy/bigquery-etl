-- Aggregated DAU and metrics based on dimensions relevant for incidents investigation
...
SELECT
  ...
  COUNT(DISTINCT IF(submission_date = first_seen_date, client_id, NULL)) AS new_profiles SUM(
    search_count
  ) AS search_count,
